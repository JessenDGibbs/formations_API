...
def edge_contraction(G):
    ...
    v, u, contracted_G, list_contraction, good_verts = contract(G, [], good_verts)
...
def create_plan(input_graph_data):
    ...
    triangular_G, added_edges_triang = triangulate_MCSM(biconnect_augment_G, randomized=False, reduce_graph=False)["H"]
